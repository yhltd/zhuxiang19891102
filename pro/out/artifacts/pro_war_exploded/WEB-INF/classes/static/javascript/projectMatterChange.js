$(function () {
    ...
    $('#select-btn').click(function () {
        let params = {
            ...
            code: $('#matterCode-select').val(),
            updateMan: $('#updateMan-select').val()
        }

        $ajax({
            type: 'post',
            url: '/matter_project_change/select_list',
    ...
    $('#refresh-btn').click(function () {
        ...
        $('#matterCode-select').val('')
        $('#updateMan-select').val('')
        getList(function(){
            alert('已刷新');
        });
...
function getList(callback) {
    $ajax({
        type: 'post',
        url: '/matter_project_change/post_list'
    }, false, '', function (res) {
        if (res.code == 200) {
            setTable(res.data);
